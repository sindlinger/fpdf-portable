...
namespace FilterPDF.Commands
{
    ...
    /// Uso: fpdf inspect --input file.pdf [--limit N]
    /// </summary>
    public class InspectPdfCommand : Command
    {
        ...
        {
            Console.WriteLine("fpdf inspect --input file.pdf [--limit N]");
            Console.WriteLine("Lista ids de objeto, tipo e subtipo (diagnóstico rápido).");
        }
    }
}
