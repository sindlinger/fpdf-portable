...
namespace FilterPDF.Commands
{
    ...
    /// Uso: fpdf deep-objects --input file.pdf [--limit N]
    /// </summary>
    public class DeepPdfObjectAnalyzerCommand : Command
    {
        ...
        {
            Console.WriteLine("fpdf deep-objects --input file.pdf [--limit N]");
            Console.WriteLine("Lista objetos com tipo/subtipo e tamanho de streams.");
        }
    }
}
