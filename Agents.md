...
- Raw completo retornado pelo C# fica em `raw_processes` (Postgres); dados parseados ficam em `processes.json` (documentos aninhados no próprio processo). Tabela `documents` não é usada.
